class gatewayCfg:
    ...
    SERVER_PUB_KEY = "-----BEGIN PUBLIC KEY-----\n" \
        "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEA2ZwvPKIxpFwPaoIy2bbJ" \
        "Oez3/HjLFP9zP1DvJxGqTufXui0+WiuDBfL42rbWsXM+SVT7zeVo9Pj7/JObOVkV" \
        "eZ9sBMRUeA1guzBUC9Vxs2ve571ZsEydu0nvvKABiWsDymnyzwIimyjuL2EzGufW" \
        "mU5Fh35cr4bMm3vZ96Jjc0EducTi2zJGraxknqaXOezk4ebUOvGXNeTBzc/jgTSO" \
        "qNbNRsAFR0VZ9rKI8u/gN1WG3hl+reXW+wuZS7PKCvADlbsyEf7ZaX+xZTNBiQRP" \
        "KEZZUUeH7tqh6SprKUJcVEXuqWIKONpFdQeTqGyehUjbwzX1o+/oI++hccBN3Yfs" \
        "xwIDAQAB\n" \
        "-----END PUBLIC KEY-----"
